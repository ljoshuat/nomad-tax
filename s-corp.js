...
function ExportReminders() {
  ...
  $(".add-dependent").on("click", function () {
    ...
    $("#officer-ssn").attr("data-name", "SSN Officer_#" + dependentNumber);
    $("#officer-title").attr("data-name", "Title Officer_#" + dependentNumber);
    $("#officer-email").attr("data-name", "Email Officer_#" + dependentNumber);
    $("#officer-telephone").attr(
      "data-name",
      "Telephone Officer_#" + dependentNumber
    );
    $("#Officer-Street-Address").attr(
      "data-name",
      "Address Line 1 Officer_#" + dependentNumber
    );
    $("#Officer-Street-Address-line-2").attr(
      "data-name",
      "Address Line 2 Officer_#" + dependentNumber
    );
    $("#officer-city").attr("data-name", "City Officer_#" + dependentNumber);
    $("#Officer-State-Province-or-Region").attr(
      "data-name",
      "State/Province/Region Officer_#" + dependentNumber
    );
    $("#Officer-Zip-or-Postal-Code").attr(
      "data-name",
      "Zip/Postal Code Officer_#" + dependentNumber
    );
    $("#currency-field").attr(
      "data-name",
      "Compensation Officer_#" + dependentNumber
    );
  });
  ...
  $(".add-shareholder").on("click", function () {
    ...
    $("#Shareholder-Street-Address").attr(
      "data-name",
      "Address Line 1 Shareholder_#" + shareholderNumber
    );
    $("#Shareholder-Street-Address-line-2").attr(
      "data-name",
      "Address Line 2 Shareholder_#" + shareholderNumber
    );
    $("#shareholder-city").attr(
      "data-name",
      "City Shareholder_#" + shareholderNumber
    );
    $("#Shareholder-State-Province-or-Region").attr(
      "data-name",
      "State/Province/Region Shareholder_#" + shareholderNumber
    );
  ...
  $(".employees").on("click", function () {
    ...
    if (ownAhome == "Yes") {
      ...
      $(".is--own-a-home :input").removeAttr("disabled");
    } else {
      let clearInputs = $(".other-states-condition.is--own-a-home");
      $(".is--own-a-home :input").attr("disabled", "disabled");
      $(clearInputs).find("input:radio").prop("checked", false);
  ...
  $(".radio-button-field.is--stock-ownership").on("click", function () {
    let yesAnswer = $('input[name="Changes-in-stock-ownership"]:checked').val();
  
    if (yesAnswer === "Yes") {
      $(".is--changes-in-stock-ownership").addClass("show");
      $("#Describe-the-changes-in-stock-ownership").attr("required", true);
  
      $(".is--changes-in-stock-ownership :input").removeAttr("disabled");
    } else {
      $(".is--changes-in-stock-ownership").removeClass("show");
      $("#Describe-the-changes-in-stock-ownership").val("");
  
      $(".is--changes-in-stock-ownership :input").attr("disabled", "disabled");
      $("#Describe-the-changes-in-stock-ownership").attr("required", false);
      $(".is--changes-in-stock-ownership .complete-text-error").removeClass(
        "show"
      );
    }
  });
  ...
  // $(".next-button-trigger").each(function () {
